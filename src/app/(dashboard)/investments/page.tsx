    ...
    <div className="opacity-80">
      ...
      <div className="rounded-lg border border-dashed border-border py-8 flex flex-col items-center justify-center bg-muted/20 text-muted-foreground">
        ...
        <p className="font-medium text-center px-4">
          Em breve: Controle de {genericName} será liberado na versão 1.1.0
        </p>
      </div>
    </div>
  );
  ...
  return (
    <>
      ...
      <div className="space-y-12">
        ...
        <FutureSection
          title="Fixas (Tesouro, CDBs longos)"
          description="Títulos públicos e privados travados até o vencimento."
          genericName="Fixas"
        />
        <FutureSection
          title="Ações (BR)"
          description="Ações negociadas na B3."
          genericName="Ações"
        />
        <FutureSection
          title="FIIs"
          description="Fundos Imobiliários e Fiagros."
          genericName="FIIs"
        />
        <FutureSection
          title="Cripto"
        ...
        <FutureSection
          ...
          description="Previdência privada, exterior, etc."
